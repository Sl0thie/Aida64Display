namespace Aida64Display.Views
{
    ...
    /// <summary>
    /// VolumeMixerPage content page.
    /// </summary>
    public class VolumeMixerPage : BaseView
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VolumeMixerPage"/> class.
        /// </summary>
        public VolumeMixerPage()
        {
            // Create and connect to the view model.
            VolumeMixerViewModel vm = new VolumeMixerViewModel();
            BindingContext = vm;
            vm.Update += VmUpdate;
        }
